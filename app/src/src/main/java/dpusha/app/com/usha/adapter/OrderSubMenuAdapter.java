...
public class OrderSubMenuAdapter extends RecyclerView.Adapter<OrderSubMenuAdapter.MyViewHolder> {
    ...
    String items[]={"By Item Code","By Category","By Cart","By Template"};
    List<String> drawerSubItems=new ArrayList<>(Arrays.asList(items));


    public OrderSubMenuAdapter(Context context) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (context instanceof DrawerMainActivity) {
                        ((DrawerMainActivity) context).onLeftDrawerBookOrderItemClick(getAdapterPosition());
                    }
                }
            });
        }
